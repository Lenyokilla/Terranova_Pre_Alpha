...
const CULTURE = {
  ...
  amphitheater: { label:'Amphitheater', glyph:'🏟️', foot:[3,2], h:38, tiers:3, stage:false, arches:true, arcLevels:2, roof:'#d9c49b', accent:'#caa24a', trim:'#b23a2c', cost:170, up:4, every:13, jobs:4, life:42 },
